...
public class CharacterController : MonoBehaviour{
	...
	[HideInInspector]
	public float inputDashVertical = 0;
	[HideInInspector]
	public float inputDashHorizontal = 0;
	[HideInInspector]
	public float inputHorizontal = 0;
	[HideInInspector]
	public float inputVertical = 0;
	[HideInInspector]
	public bool inputDiUp;
	[HideInInspector]
	public bool inputDiDown;
	[HideInInspector]
	public bool inputDiLeft;
	[HideInInspector]
	public bool inputDiRight;
	[HideInInspector]
	...
	void Update(){
		...
		if(animator){
			...
			if(inputFire){
				if(useMeshNav)
				{
					navMeshAgent.destination = TarPos;
				}
				...
				if(weapon == Weapon.TWOHANDBOW && isAiming){
					animator.SetTrigger("Attack1Trigger");
				}
			}
			if(inputReload){
	...
	void RotateTowardsMovementDir(){
		if(inputVec != Vector3.zero && !isStrafing && !isAiming && !isRolling && !isBlocking && CharacterState != CharacterState.CLIMBING){
